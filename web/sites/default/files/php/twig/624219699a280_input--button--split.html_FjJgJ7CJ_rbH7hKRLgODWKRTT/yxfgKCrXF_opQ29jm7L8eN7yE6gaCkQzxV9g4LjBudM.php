...
class __TwigTemplate_5e3d138de8c61f28c5e5255c7c24b109 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button--split.html.twig", "C:\\xampp\\htdocs\\my_site_name_dir\\web\\themes\\bootstrap\\templates\\input\\input--button--split.html.twig");
    }
